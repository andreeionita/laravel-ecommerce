                    ...
                    <tbody>
                        ...
                        {{-- {{dd($product)}} --}}
                            <tr>
                                <td>
                                    <figure class="media">
                                        <div class="img-wrap"><img src="{{asset($product['product']->thumbnail)}}" class="img-thumbnail img-sm"></div>
                                ...
                                <td>
                                    ...
                                    {{-- <form action="{{route('cart.update',['product'=>$product['product']->slug])}}" method="POST" accept-charset="utf-8">
                                        @csrf --}}
