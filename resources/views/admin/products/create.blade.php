		...
		<div class="form-group row">
			<div class="card col-sm-12 p-0 mb-2">
				...
				<div class="card-body" id="extras">
					<div class="row align-items-center options mb-2">
						<div class="col-sm-4">
		...
		<ul class="list-group row">
			...
			<li class="list-group-item">
				...
				<div class="img-thumbnail  text-center">
					<img src="@if(isset($product)) {{asset('images/'.$product->thumbnail)}} @else {{asset('https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png')}} @endif" id="imgthumbnail" class="img-fluid" alt="">
				</div>
			</li>
			<li class="list-group-item">
				<div class="col-12">
